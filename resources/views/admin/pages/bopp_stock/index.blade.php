                ...
                <div class="page-header-content d-lg-flex">
                    <div class="d-flex">
                        <h4 class="page-title mb-0">
                            Dashboard - <span class="fw-normal">Bopp Stock Category List</span>
                        </h4>
                        <a href="#page_header"
            ...
            <div class="content">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">BOPP Category List</h5>
                        <div class="card-tools text-end"
                            style="display: flex; align-items:center; justify-content: space-between;">
                            <div class="btns">
                                @if (hasPermission('Bopp Stock Categories Save', 'Save'))                                    
                                <a href="#" class="text-white btn btn-primary-2" data-toggle="modal" data-target="#users">Add Category</a>
                                @endif
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('admin.bopp-stock-pp-categories.save')}}" method="post">
                    @csrf
                    <div class="form-body">
...
<script>
    $(document).ready(function () {
        var RoleTable = $('#role-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('bopp-stock.categories.view') }}",
                data: function (d) {
                    d.status = $('#status').val();
                }
            },
            columns: [
                ...
                @endif
                { data: 'category_name', name: 'role_name', width:'15%' },
                { data: 'category_value', name: 'category_value', width:'15%'},
