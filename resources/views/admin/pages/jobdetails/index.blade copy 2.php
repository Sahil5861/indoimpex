                    ...
                    <div class="form-body">                        
                        ...
                        <div class="form-2" style="display: none">                                                    
                            ...
                            <div class="row">                            
                                ...
                                <div class="col-md-10" id="gaz_bag" style="display:none">                                    
                                    <div class="form-group">
                                        <label>Bag Size <span class="text-danger">*</span></label>  
                                        <div class="row mb-3 d-flex justify-content-start align-items-start">
                                            <div class="col-md-3">
                                                ...
                                                <p class="my-2" id="job_size" style="dispaly:block; height:24px; font-weight:bold;"></p>
                                            </div>
                                            <p></p><br>
                                            X 
                                            <div class="col-md-3">
                                                ...
                                                <p class="my-2" id="bag_pet_inch" style="dispaly:block; height:24px; font-weight:bold;"></p>
                                            </div>
                                            <p></p><br>
                                            X
                                            <div class="col-md-3">
                                                ...
                                                <p class="my-2" id="bag_gazette_inch" style="dispaly:block; height:24px; font-weight:bold;"></p>                                                
                                            </div>
                                        </div>
                                    </div>                                                                
                                </div>   
                            ...
                            <div class="row">
                                        ...
                                        <div class="row g-2" style="margin-top:0;">
                                            ...
                                            <div class="col mb-3 ">
                                                ...
                                                <div class="cmyk-popup" id="cmyk-picker-{{ $i }}" data-index="{{ $i }}" style="display: none; position: absolute; top: 100%; left: %; width:100%; z-index: 1000; background: #fff; padding: 10px; border: 1px solid #ccc; border-radius: 5px;">
                                                    <div class="row g-1">
                                                        <div class="col-md-12"><input type="text" id="cmyk-input-C-{{$i}}" class="form-control cmyk-input" placeholder="C" min="0" max="100" data-channel="c" oninput="this.value = this.value.replace(/[^0-9]/, '');"></div>
                                                ...
                                                <input type="text" name="color_name[]" id="color_name_{{$i}}" class="form-control my-1 color_name">                                           
                                            </div>
                                            @endfor
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>KLD</label>
                                        <input type="file" class="form-control image-input" id="kld_images" autocomplete="off"  placeholder="Job Name" name="kld[]" multiple onchange="previewKLDImages(this)">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Mockups</label>
                                        <input type="file" class="form-control image-input" id="mock_up_images" autocomplete="off"  placeholder="Job Name" name="files[]" multiple onchange="previewMockupImages(this)">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control image-input" id="suppression_images" autocomplete="off"  placeholder="Job Name" name="suppression[]" multiple onchange="previewSuppressionImages(this)">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control image-input" id="approval_images" autocomplete="off"  placeholder="Job Name" name="approve[]" multiple onchange="previewApproveImages(this)">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label>GMS</label>
                                    <div class=" input-group ">
                                        <input type="text" class="form-control lamination_gsm" autocomplete="off"  placeholder="GMS" name="lamination[job_lamination_gsm]" oninput="this.value = this.value.replace(/[^0-9]/, '');">
                                        <div class="input-group-append">
                                            <span class="input-group-text">GMS</span>
                                        </div>
                                    </div>
                            ...
                            <div id="handle-weight-bag-div">
                                ...
                                <div class="row" id="handle_detail">
                                    ...
                                    <div class="col-md-4 handle_gsm">
                                        <label>GMS</label>
                                        <div class=" input-group ">
                                            <input type="text" class="form-control" autocomplete="off" placeholder="GMS" name="handle[job_handle_gsm]" oninput="this.value = this.value.replace(/[^0-9]/, '');">
                                            <div class="input-group-append">
                                                <span class="input-group-text">GMS</span>
                                            </div>
                                        </div>
...
<script>
    ...
    $(document).on("click",".job_bag_type",function(){                  
        ...
        if(name.trim() == 'Pillow Bag'){            
            ...
            $('.lamination_weight').html('Lamination Weight/Bag');
            $('.bopp_weight').html('BOPP Weight/Bag');
            $('.fabric_weight').html('Fabric Weight/Bag');
            ...
            $('.lamination_weight').html('Lamination Weight/Sheet');
            $('.bopp_weight').html('BOPP Weight/Sheet');
            $('.fabric_weight').html('Fabric Weight/Sheet');
    ...
    $(document).on("click", ".bag_type", function(e) {
        ...
        if ((printing_type == "BOPP") || (printing_type == "OFFSET") || (printing_type == "FLEXO On BOPP")) {
            ...
            $("#u_cut").css("cursor", "pointer").removeClass('disabled-input').addClass('active');
        }
