                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools text-end"
                            ...
                            <div class="btns">
                                <a href="#" class="text-white btn btn-primary-2" data-toggle="modal" data-target="#users">Add Roles</a>
                            ...
                            <div class="dropdown">
                                ...
                                <a href="{{route('admin.permissions')}}" class="text-white btn btn-primary-2" data-target="#users">Permissions</a>
                                @endif
