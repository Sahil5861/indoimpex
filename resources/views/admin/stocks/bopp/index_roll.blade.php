...
<div class="page-content">
    @include('admin.stocks.bopp.sidebar', ['sidebarTitle' => 'BOPP | Consolidated'])
            ...
            <div class="content">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">BOPP | Roll Form</h5>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="roll-table" class="table table-bordered text-center table-striped">
                                <thead>
                                    <th>S.NO</th>
                                    <th>Roll No.</th>
                                    <th>Size</th>
